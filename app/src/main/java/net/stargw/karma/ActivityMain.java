...
public class ActivityMain extends Activity implements ActivityMainListener{
    ...
    private class BroadcastListener extends BroadcastReceiver {
        public void onReceive(Context context, Intent intent) {
            ...
            if (Global.NETCONTROL_STATE_CHANGE.equals(intent.getAction()) ) {
                Logs.myLog("Process Global.NETCONTROL_STATE_CHANGE", 2);
                updateNetControlStateDisplay(true);
            }
    ...
    void updateNetControlStateDisplay(boolean fromService)
    {
        if (Global.getNetControlState() == false) {
            findViewById(R.id.activity_main_netcontrol_message).setVisibility(View.VISIBLE);
            ImageView i = (ImageView) findViewById(R.id.activity_main_firewall_icon);
            i.setColorFilter(Color.RED);
        } else {
            findViewById(R.id.activity_main_netcontrol_message).setVisibility(View.GONE);
            ImageView i = (ImageView) findViewById(R.id.activity_main_firewall_icon);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (requestCode == 666)
        {
            ...
            if (resultCode == RESULT_OK) {
                ...
                serviceIntent.putExtra("command", Global.NETCONTROL_START);
    ...
    protected void onResume() {
        ...
        updateAppListCopyListView();
        updateNetControlStateDisplay(false);
        ...
        mIntentFilter.addAction(Global.NETCONTROL_STATE_CHANGE);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.action_always:
                        ...
                        if (Global.getNetControlState() == false) {
                            // turn on the netcontrol as well..
...
*/
        ...
        findViewById(R.id.activity_main_firewall_icon).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Logs.myLog("Toggle NetControl State Prompt", 2);
                confirmNetControlStateChange(c);
            }
        });
    ...
    public void changeSelectedItem(int position) {
        ...
        toggleNetControlApp(thisApp);
        updateAppListCopyListView();
    }


    private void toggleNetControlApp(AppInfo thisApp)
    {
        Logs.myLog("ActivityMain - toggleNetControlApp()", 2);
        ...
        Logs.myLog("toggleNetControlApp: " + thisApp.name, 2);
    ...
    //
    public void confirmNetControlStateChange(Context c) {
        final Dialog info = new Dialog(c);
        ...
        ImageView toggle = (ImageView) findViewById(R.id.activity_main_firewall_icon);
        if (Global.getNetControlState() == true) {
            text.setText(R.string.disable_netcontrol_message);
            info.setTitle(R.string.disable_netcontrol);
        } else {
            text.setText(R.string.enable_netcontrol_message);
            info.setTitle(R.string.enable_netcontrol);
        }
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Global.getNetControlState() == true) {
                    Intent serviceIntent = new Intent(Global.getContext(), ServiceFW.class);
                    serviceIntent.putExtra("command", Global.NETCONTROL_STOP);
                    Global.getContext().startService(serviceIntent);
                } else {
                    ImageView toggle = (ImageView) findViewById(R.id.activity_main_firewall_icon);
    ...
    private void showNewApps()
    {
        ...
        dialogNewApps.setTitle("New Apps to Block");

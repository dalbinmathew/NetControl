...
public class Widget1Provider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // Toggle NetControl - via specific targeted Intent
        if ((intent.getAction() != null) && (intent.getAction().equals(Global.TOGGLE))) {
            ...
            if (Global.getNetControlState() == true) {
                ...
                serviceIntent.putExtra("command", Global.NETCONTROL_WIDGET);
            ...
            // No need to update widgets - NetControl state change will update
        }
